...
describe('delete employee', () => {
    ...
    describe('Email API tests', () => {
      it('should retrieve the first email body from the inbox', async () => {
        const emailApiEndpoint = 'https://api.example.com/emails';
        const response = await axios.get(emailApiEndpoint);
        
        // Assuming the response structure and data format
        const firstEmailBody = response.data[0].body;
    
        expect(firstEmailBody).to.not.be.undefined;
